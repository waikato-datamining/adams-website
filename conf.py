...
BLOG_TITLE = "ADAMS"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://adams.cms.waikato.ac.nz/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://adams.cms.waikato.ac.nz/"
BLOG_EMAIL = "theadamsflow@gmail.com"
BLOG_DESCRIPTION = "The Advanced Data mining And Machine learning System (ADAMS) is a novel, flexible workflow engine aimed at quickly building and maintaining real-world, complex knowledge workflows, released under GPLv3."  # (translatable)
...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -rav --delete output/ --exclude mantisBT --exclude events --exclude old --exclude releases --exclude snapshots --exclude jdk --exclude cloud fracpete@adams-web.cms.waikato.ac.nz:/var/www/html",
    ]
}
